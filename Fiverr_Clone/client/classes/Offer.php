...
class Offer extends Database {
    ...
    public function createOffer($user_id, $description, $proposal_id) {
        ...
        if ($this->hasUserSubmittedOffer($user_id, $proposal_id)) {
            return false; // User has already submitted an offer
        }
     ...
     * @return bool True if user has already submitted an offer, false otherwise.
     */
