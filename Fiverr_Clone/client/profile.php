      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-3 text-center">
            <img src="<?php echo !empty($userInfo['display_picture']) ? '../images/'.$userInfo['display_picture'] : 'https://via.placeholder.com/150x150/007bff/ffffff?text='.strtoupper(substr($userInfo['username'], 0, 2)); ?>" 
                 class="profile-image" alt="Profile Picture">
          </div>
          <div class="col-md-9">
            <h1 class="display-4 fw-bold mb-2">
              <i class="fas fa-user-tie me-3"></i>Welcome, <?php echo htmlspecialchars($userInfo['username']); ?>!
            </h1>
            <p class="lead mb-0">Manage your client profile and preferences</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body p-4">
              <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="bio_description" class="form-control" rows="4" placeholder="Tell us about yourself..."><?php echo htmlspecialchars($userInfo['bio_description']); ?></textarea>
                </div>
